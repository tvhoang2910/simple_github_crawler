...
def fetch_commits(
    owner: str, repo_name: str, per_page: int = 10
) -> List[Dict[str, Any]]:
    """Fetch recent commits for a repository."""
    url = (
        f"https://api.github.com/repos/{owner}/{repo_name}/commits?per_page={per_page}"
    )
    data = fetch_with_retry(url)
    return data if data else []
...
def fetch_compare_commits(
    owner: str, repo_name: str, base: str, head: str
) -> List[Dict[str, Any]]:
    """
